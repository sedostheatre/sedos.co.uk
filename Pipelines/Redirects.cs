    ...
    public class Redirects : Pipeline
    {
        public Redirects()
        {
            ...
            var temporaryCustomRedirects = new Dictionary<string, string>() {
                ...
                { "pitch-guidance", "https://docs.google.com/document/d/1CqludTc7B7AqQjgUmy_QLZzKNlOiVakFTLIl-WreI_A/edit?usp=sharing" },
                { "pitch-form", "https://docs.google.com/document/d/1eDo03jniTA0DRGego_ESnmvWfgeVRyugRj_nFfZ7Hng/edit?usp=sharing" },
