    ...
    public class Redirects : Pipeline
    {
        public Redirects()
        {
            ...
            var temporaryCustomRedirects = new Dictionary<string, string>() {
                ...
                { "pitch-guidance", "https://docs.google.com/document/d/1M5HjHVzfG6zuEQRgKELIl8Ooi3p-Lt-9MwyoEQn5CxI/edit?usp=sharing" },
                { "pitch-form", "https://docs.google.com/document/d/14ckgYll-dlxlaACGGflle3wfOg1XSrzRlncg6h8bN7g/edit?usp=sharing" },
